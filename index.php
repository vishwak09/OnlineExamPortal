...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <p><strong>Karthik Raj</strong></p>
        <p>4th year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <p><strong>Akshay Reddy</strong></p>
        <p>4th year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <p><strong>Vignesh</strong></p>
        <p>4th year BTECH</p>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> Telangana, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 9963603474 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> kartikraj1256@gmail.com</p>
    </div>
